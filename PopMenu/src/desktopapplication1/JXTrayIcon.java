...
public class JXTrayIcon extends TrayIcon {
    ...
    private static TipWindow tipWindow = new TipWindow();
//    private TipWindow tipWindow;
    ...
    static {
        ...
        timer.schedule(popTimer, 1000, 5000);//在1秒后执行此任务,每次间隔2秒,如果传递一个Data参数,就可以在某个固定的时间执行这个任务.
        //end
    }
...
//        if (e.isPopupTrigger() && menu != null) {
    ...
    static Image createImage() {
        ...
        try {
            ...
            Logger.getLogger(JXTrayIcon.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }

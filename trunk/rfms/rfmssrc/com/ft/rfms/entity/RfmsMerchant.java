...
/**
  * RfmsMerchant.java Create on 2008-12-16 15:38:49
  * <p> 
  * 实体类:RfmsMerchant
  * <p>
  * 对应表名:RFMS_MERCHANT
...
public class RfmsMerchant implements Serializable,IBaseEntity {
...
/*[CONSTRUCTOR MARKER BEGIN]*/
	 ...
	 */
	public RfmsMerchant (Long merchantId) {
...
/*[CONSTRUCTOR MARKER END]*/
	...
	public static String REF = "RfmsMerchant";
	...
	private java.lang.Long commisionStep;
    private java.lang.Long regionId;
	private java.lang.String industry;
	private java.lang.String mlevel;
	private java.lang.Long amount; //账户金额
	 ...
	 */
	public java.lang.Long getCommisionStep() {
		return commisionStep;
	}

	/**
	 * @param commisionStep the commisionStep to set
	 */
	public void setCommisionStep(java.lang.Long commisionStep) {
		this.commisionStep = commisionStep;
	}
	 ...
	 * @param merchantId the new ID
	 */
	public void setMerchantId (java.lang.Long merchantId) {
		this.merchantId = merchantId;
		this.hashCode = Integer.MIN_VALUE;
	}
	public void setId (java.lang.Long merchantId) {
		this.merchantId = merchantId;
		this.hashCode = Integer.MIN_VALUE;
	}
	 ...
	 * @param bankAccountCode the INDUSTRY value
	 */
	...
	/**
	 * Return the value associated with the column: MLEVEL
	 */
	...
	/**
	 * Set the value related to the column: MLEVEL
	 * @param bankAccountCode the MLEVEL value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof RfmsMerchant)) return false;
		else {
			RfmsMerchant rfmsMerchant = (RfmsMerchant) obj;
			if (null == this.getMerchantId() || null == rfmsMerchant.getMerchantId()) return false;
			else return (this.getMerchantId().equals(rfmsMerchant.getMerchantId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getMerchantId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getMerchantId().hashCode();

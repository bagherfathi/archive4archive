...
//* 这时请修改图片相对路径: this.imageRelativePath = "/sso/images/calendar";
//*
//**



document.write("<div id=eosCalendarLayer style='position: absolute; z-index: 9999; width: 185; height: 215; display: none'>");
document.write("<iframe src='javascript:false' name=eosCalendarIframe scrolling=no frameborder=0 width=100% height=100%></iframe></div>");
...
function writeIframe(parent)	//对iframe进行初始化
{
	...
	{ 
		strIframe += "<script language=javascript>"+
			"var drag=false, cx=0, cy=0, o = parent.WebCalendar.calendar; var flag=true; function document.onmousemove(){"+
			...
			"function scrolltextarea(obj,min,max){ var textareaMin = min; var textareaMax = max;if(flag){obj.scrollTop=0; flag=false;}; if (obj.scrollTop==0)"+
	...
	*/
    ...
    "<tr><td>"+
    "<table width=180 height=30 id=tableHead border=0 cellspacing=0 cellpadding=0 background='<c:url value="/imagescalendar/TaskBarBG.gif"/>' bgcolor='#255FDC'><tr align=center>"+
	"<td><image class='operate' src='<c:url value="/images/calendar/_calprevyr.gif"/>' title='向前翻 1 年&#13;快捷键：↑' onclick='parent.prevY()' onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==1000)'></td>" + 
	"<td><image class='operate' src='<c:url value="/images/calendar/_calprevmm.gif"/>' onfocus='this.blur()' title='向前翻 1 月&#13;快捷键：←' onclick='parent.prevM()'>"+
    "</td>"+
	...
	"</td><td width=15>月</td>"+
	"<td align=right><image class='operate' src='<c:url value="/images/calendar/_calnextmm.gif"/>' title='向后翻 1 月&#13;快捷键：→' onclick='parent.nextM()' onfocus='this.blur()'></td>"+
	"<td><image class='operate' src='<c:url value="/images/calendar/_calnextyr.gif"/> ' title='向后翻 1 年&#13;快捷键：↓' onclick='parent.nextY()' onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==9999)'></td></tr>"+
	"<tr><td colspan=8 width=180 height=2 background='<c:url value="/images/calendar/progressBar.gif"/> '></td></tr>"+
	"</table></td></tr>"+
	...
	*/
	if(parent.timeShow) 	
		strIframe += "<tr><td width=180 height=20>"+
	...
	strIframe +="<tr><td height=20 width=180>"+
		"<table width='100%' height='100%' border=0 cellpadding=0 cellspacing=0 bgcolor='"+ parent.darkColor + "'><tr><td align=center>"+
		"<a href='javascript:parent.returnCurDate();' onfocus='this.blur()' title='今天&#13;快捷键：T'>"+
		"<font color='#444444' style='font-size:12px;'>今天</font></a></td>"+
		"<td align=center><a href='javascript:parent.getInputId();' onfocus='this.blur()' title='清除'>"+
		"<font color='#444444' style='font-size:12px;'>清除</font></a></td>"+
		"<td align=center><a href='javascript:parent.hiddenCalendar();' onfocus='this.blur()' title='关闭&#13;快捷键：X'>"+
		"<font color='#444444' style='font-size:12px;'>关闭</font></a></td></tr></table></td></tr><table></div></form></body></html>";
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.todayColor = "#FFD86F";    //今天在日历上的标示背景色
...
{
    //----add by 岳红----
	var mm1 = WebCalendar.iframe.meizzYearMonth.innerText;
	    WebCalendar.thisMonth = mm1;
	//----end----
...
function funYearSelect() //年份的下拉框
{
    ...
    //----add by 岳红----
	var yy1 = WebCalendar.iframe.meizzYearHead.innerText; 
	    WebCalendar.thisYear = yy1;
	//----end----
...
function prevM()  //往前翻月份
{
	...
	m = WebCalendar.iframe.meizzYearMonth.innerText;
	//alert(WebCalendar.iframe.meizzYearMonth.innerText);
	y = WebCalendar.iframe.meizzYearHead.innerText;
...
//往前翻 Year
function prevY()
{WebCalendar.thisDay = 1; y = WebCalendar.iframe.meizzYearHead.innerText; WebCalendar.thisYear = y; WebCalendar.thisYear--; writeCalendar();}
...
function writeCalendar() 
{
    ...
    for(var i=0; i<42; i++)    //这个循环是根据源数组写到日历里显示
    {
        ...
        if ((i<10 && parseInt(WebCalendar.day[i], 10)>20) || (i>27 && parseInt(WebCalendar.day[i], 10)<15)) //edit by 岳红

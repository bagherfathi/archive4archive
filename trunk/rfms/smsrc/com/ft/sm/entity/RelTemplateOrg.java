/**
 * @{#} RelTemplateOrg.java Create on 2006-12-25 14:00:57
 *
...
/**
 * This is an object that contains data related to the SM_REL_TEMPLATE_ORG table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="SM_REL_TEMPLATE_ORG"
 */


public class RelTemplateOrg implements Serializable {
        private static final long serialVersionUID = 1L;

	public static String REF = "RelTemplateOrg";

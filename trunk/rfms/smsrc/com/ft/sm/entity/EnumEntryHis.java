/**
 * @{#} EnumEntryHis.java Create on 2007-1-22 15:05:38
 *
...
/**
 * This is an object that contains data related to the SM_ENUM_ENTRY_HIS table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="SM_ENUM_ENTRY_HIS"
 */


public class EnumEntryHis implements Serializable {
        private static final long serialVersionUID = 1L;

	public static String REF = "EnumEntryHis";
	...
	/**
	 * Return the value associated with the column: ENUM_ENTRY_ID
	 */
	...
	/**
	 * Set the value related to the column: ENUM_ENTRY_ID
	 * @param enumEntryId the ENUM_ENTRY_ID value
	 */

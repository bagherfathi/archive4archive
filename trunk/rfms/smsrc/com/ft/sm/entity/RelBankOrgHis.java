/**
 * @{#} RelBankOrgHis.java Create on 2006-12-19 14:08:46
 *
...
/**
 * This is an object that contains data related to the SM_REL_BANK_ORG_HIS table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="SM_REL_BANK_ORG_HIS"
 */


public class RelBankOrgHis implements Serializable {
        private static final long serialVersionUID = 1L;

	public static String REF = "RelBankOrgHis";

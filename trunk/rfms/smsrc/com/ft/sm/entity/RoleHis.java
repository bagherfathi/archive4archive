/**
 * @{#} RoleHis.java Create on 2006-10-27 14:46:43
 *
...
/**
 * This is an object that contains data related to the SM_ROLE_HIS table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * 
 * @hibernate.class table="SM_ROLE_HIS"
 */

public class RoleHis implements Serializable {
    private static final long serialVersionUID = 1L;

    public static String REF = "RoleHis";

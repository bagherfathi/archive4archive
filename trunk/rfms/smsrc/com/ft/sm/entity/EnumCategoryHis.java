/**
 * @{#} EnumCategoryHis.java Create on 2006-12-20 0:01:08
 *
...
/**
 * This is an object that contains data related to the SM_ENUM_CATEGORY_HIS table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="SM_ENUM_CATEGORY_HIS"
 */


public class EnumCategoryHis implements Serializable {
        private static final long serialVersionUID = 1L;

	public static String REF = "EnumCategoryHis";

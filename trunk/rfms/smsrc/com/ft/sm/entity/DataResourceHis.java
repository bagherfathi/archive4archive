/**
 * @{#} DataResourceHis.java Create on 2006-10-27 14:46:43
 *
...
/**
 * This is an object that contains data related to the SM_DATA_RESOURCE_HIS
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 * 
 * @hibernate.class table="SM_DATA_RESOURCE_HIS"
 */

public class DataResourceHis implements Serializable {
    private static final long serialVersionUID = 1L;

    public static String REF = "DataResourceHis";

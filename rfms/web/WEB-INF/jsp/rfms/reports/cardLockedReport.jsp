...
<form name="freport" action="../ReportServer" method="get">
 <input type="hidden" name="reportlet" value="/com/ft/cardLockedReport.cpt"/>
 <input type="hidden" name="beginDate"/>
 <input type="hidden" name="endDate"/>
</form>
<html:form action="/cardReport" method="post">
	<input type="hidden" value="search" name="act" />
	<webui:panel title="冻结卡报表"
		icon="../images/icon_search.gif" width="95%">
		<webui:formTable>
			<tr>
<!-- 				<webui:input label="统计开始时间">
					<webui:calendar id="beginDate" property="beginDate" defaultToday="true" readonly="true"/>
				</webui:input> -->
				<webui:input label="统计结束时间">
					<webui:calendar id="endDate" property="endDate" defaultToday="true"  readonly="true"/>
				</webui:input>
			</tr>
		</webui:formTable>

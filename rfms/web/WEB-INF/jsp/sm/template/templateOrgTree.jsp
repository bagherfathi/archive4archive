...
<div id="treeboxbox_tree" />
 ...
 <script>
		...
		tree.loadXML("<c:url value="/sm/treeXml.do?beanName=orgManager&childType=1"/>");
		tree.setXMLAutoLoading("<c:url value="/sm/treeXml.do?beanName=orgManager&childType=1"/>");
		tree.setImagePath("<c:url value="/images/"/>");
		tree.setOnClickHandler(doOnSelect);		
		function doOnSelect(itemId){
           parent.rightFrame.location.href='<c:url value="/sm/templateBind.do?orgId="/>'+ itemId;
		}		
</script>
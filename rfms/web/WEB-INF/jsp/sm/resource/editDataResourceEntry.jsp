...
<html:form styleId="dataResourceEntryMultiForm" action="/dataResource.do"  method="post" onsubmit="return onSubmit(this);">
	<html:hidden property="act" value="editEntry"/>
	<input type="hidden" name="id" value="<c:out value='${dataResource.resourceId}'/>" />
	<webui:panel title="sysadmin.label.dataResource.entry.edit" width="95%">
		<webui:formTable>

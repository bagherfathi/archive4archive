 ...
 *
 */
public class MerchantTradeSearchAction extends BaseAction {
	...
	protected ActionForward unspecified(ActionMapping arg0, ActionForm arg1, HttpServletRequest arg2, HttpServletResponse arg3) throws Exception {
		...
		List tradeStatuses=this.reportService.getTreadStatus();
		arg2.setAttribute("tradeStatuses", tradeStatuses);

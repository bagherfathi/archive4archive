...
public interface MerchantService extends BaseService {
	 ...
	 * @throws Exception
	 */
	public void saveOrUpdateMerchant(RfmsMerchant merchant,List<RfmsMerchantBranch> branchs,Map<String,RfmsCommisionStep> steps,Long[] nextOperatorIds,AppRequest appRequest)throws Exception;
	 ...
	 * @throws Exception
	 */
	public List findNextCtrlRoleIdsByStatusBefore(Long curStatus)throws Exception;
	...
	public List findMerchantsByOperatorAndAuditStatus(Long operatorId,Long auditStatus)throws Exception;

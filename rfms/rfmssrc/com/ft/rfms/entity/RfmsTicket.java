...
/*[CONSTRUCTOR MARKER END]*/
	 ...
	 * @param ticketSerial the TICKET_SERIAL value
	 */
	 ...
	 * @param sendCount the SEND_COUNT value
	 */
	 ...
	 * @param useCount the USE_COUNT value
	 */
	 ...
	 * @param parZhekou the PAR_ZHEKOU value
	 */
	 ...
	 * @param targetMemberType the TARGET_MEMBER_TYPE value
	 */
	 ...
	 * @param useRule the USE_RULE value
	 */
	 ...
	 * @param ohterInfo the OHTER_INFO value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof RfmsTicket)) return false;
		else {
			RfmsTicket rfmsTicket = (RfmsTicket) obj;
			if (null == this.getTicketId() || null == rfmsTicket.getTicketId()) return false;
			else return (this.getTicketId().equals(rfmsTicket.getTicketId()));
		}
	}

	public int hashCode () {
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getTicketId()) return super.hashCode();
			else {
				String hashStr = this.getClass().getName() + ":" + this.getTicketId().hashCode();

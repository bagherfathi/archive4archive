...
public class RfmsMerchantBranch implements Serializable, IBaseEntity {
	...
	private java.lang.String branchSerial;

	public java.lang.String getBranchSerial() {
		return branchSerial;
	}

	public void setBranchSerial(java.lang.String branchSerial) {
	 ...
	 * 
	 * @hibernate.id generator-class="identity" column="MERCHANT_BRANCH_ID"
	 */
	 ...
	 * 
	 * @param branchContactName
	 *            the BRANCH_CONTACT_NAME value
	 */
	 ...
	 * 
	 * @param sysMerchantCode
	 *            the SYS_MERCHANT_CODE value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof RfmsMerchantBranch))
			return false;
		else {
			RfmsMerchantBranch rfmsMerchantBranch = (RfmsMerchantBranch) obj;
			if (null == this.getMerchantBranchId()
					|| null == rfmsMerchantBranch.getMerchantBranchId())
				return false;
			else
				return (this.getMerchantBranchId().equals(rfmsMerchantBranch
						.getMerchantBranchId()));
		}
	}
		...
		if (Integer.MIN_VALUE == this.hashCode) {
			if (null == this.getMerchantBranchId())
				...
				String hashStr = this.getClass().getName() + ":"
						+ this.getMerchantBranchId().hashCode();

...
/**
  * RfmsMerchantBranchHis.java Create on 2008-12-16 15:38:49
  * <p> 
  * 实体类:RfmsMerchantBranchHis
  * <p>
  * 对应表名:RFMS_MERCHANT_BRANCH_HIS
  */

public class RfmsMerchantBranchHis implements Serializable {
        private static final long serialVersionUID = 1L;

/*[CONSTRUCTOR MARKER BEGIN]*/
	// constructors
	public RfmsMerchantBranchHis () {
		initialize();
	}
	 ...
	 */
	public RfmsMerchantBranchHis (Long historyId) {
...
/*[CONSTRUCTOR MARKER END]*/
	...
	public static String REF = "RfmsMerchantBranchHis";
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof RfmsMerchantBranchHis)) return false;
		else {
			RfmsMerchantBranchHis rfmsMerchantBranchHis = (RfmsMerchantBranchHis) obj;
			if (null == this.getHistoryId() || null == rfmsMerchantBranchHis.getHistoryId()) return false;
			else return (this.getHistoryId().equals(rfmsMerchantBranchHis.getHistoryId()));
		}
	}

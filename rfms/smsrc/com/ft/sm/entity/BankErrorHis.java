/**
 * @{#} BankErrorHis.java Create on 2006-12-19 13:11:18
 *
...
/**
 * This is an object that contains data related to the SM_BANK_ERROR_HIS table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="SM_BANK_ERROR_HIS"
 */


public class BankErrorHis implements Serializable {
        private static final long serialVersionUID = 1L;

	public static String REF = "BankErrorHis";
	...
	/**
	 * Return the value associated with the column: bank_error_id
	 */
	...
	/**
	 * Set the value related to the column: bank_error_id
	 * @param bankErrorId the bank_error_id value
	 */

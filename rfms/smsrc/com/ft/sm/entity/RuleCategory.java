/**
 * @{#} RuleCategory.java Create on 2006-10-27 14:46:43
 *
...
/**
 * This is an object that contains data related to the SM_RULE_CATEGORY table.
 * Do not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="SM_RULE_CATEGORY"
 */

public class RuleCategory implements Serializable {
    private static final long serialVersionUID = 1L;

    public static String REF = "RuleCategory";
